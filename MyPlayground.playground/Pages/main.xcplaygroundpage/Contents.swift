...
func places(continent: String, number: Int) {
    print("\(continent) is a continent which contains \(number) countries")
}

places(continent:"America", number: 51)
 ...
 */
// write your code here
func beerOnTheWall(number: Int, drink: String, wallType: String) {
    print("\(number) bottles of \(drink) on the \(wallType) wall.")
}


beerOnTheWall(number: 99, drink: "beer", wallType: "dry")
